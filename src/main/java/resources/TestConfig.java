...
public class TestConfig{
	...
	//public static String from = "mschiranjeevi.heggade@clarivate.com";
	public static String from = "chiranjeevi.heggade@gmail.com";
	public static String password = "Mysore@2017";
	public static String[] to ={"chiranjeevi.heggade@gmail.com"};
